...
<?php if(($isInput ?? true) && empty($hasChildren)): ?>
    ...
    <?php if($type === 'boolean'): ?>
        <label data-endpoint="<?php echo e($endpointId); ?>" hidden>
            <input type="radio" name="<?php echo e($fullName); ?>"
                   ...
                   data-component="<?php echo e($component); ?>" <?php if($required): ?>required <?php endif; ?>
            >
            <code>true</code>
        </label>
        <label data-endpoint="<?php echo e($endpointId); ?>" hidden>
    ...
    <?php elseif($isList): ?>
        <input type="<?php echo e($inputType); ?>"
               ...
               data-endpoint="<?php echo e($endpointId); ?>"
               data-component="<?php echo e($component); ?>" <?php if($required): ?>required <?php endif; ?> hidden>
        <input type="<?php echo e($inputType); ?>"
...
<?php endif; ?>
<br>
<?php echo Parsedown::instance()->text($description); ?><?php /**PATH /var/www/vendor/knuckleswtf/scribe/src/../resources/views//components/field-details.blade.php ENDPATH**/ ?>